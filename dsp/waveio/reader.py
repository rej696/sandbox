...
from .metadata import WAVMetadata


class ArraySlice:
    """numpy ndarray wrapper with frames_range attribute"""
...
class WAVReader:
    ...
    def channels_sliced(self, start_seconds=0.0, end_seconds=None):
        ...
        frames_slice = slice(
            round(self.metadata.framerate * start_seconds),
            round(self.metadata.framerate * end_seconds),
        )
